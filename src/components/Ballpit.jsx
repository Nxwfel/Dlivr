...
const Ballpit = ({ className = '', followCursor = true, ...props }) => {
  ...
  useEffect(() => {
    ...
    // Check WebGL support before attempting to create the ballpit
    const testCanvas = document.createElement('canvas');
    const gl = testCanvas.getContext('webgl') || testCanvas.getContext('experimental-webgl');
    if (!gl) {
      console.warn('Ballpit: WebGL not supported, skipping initialization.');
      return;
    }
    ...
    try {
      ...
      console.warn('Ballpit: Failed to initialize WebGL context.', error);
    }
